                      ...
                      Row(
                        children: [
                          ...List.generate(
                            ...
                            (_) => Icon(Icons.star,
                                size: 11.sp, color: const Color(0xFFD4AF37)),
                          ),
                          SizedBox(width: 5.w),
                          Container(
                            padding: EdgeInsets.symmetric(
                        ...
                        child: Row(
                          children: [
                            if (h.isRefundable) ...[
                              ...
                              if (h.hasBreakfast) SizedBox(width: 4.w),
                            ],
                            if (h.hasBreakfast)
                              const _AmenityBadge(
                                  label: 'Breakfast \u2713',
                ...
                children: [
                  Image.network(
                    ...
                    errorBuilder: (_, __, ___) => Container(
                      ...
                      child: Icon(Icons.hotel,
                          color: hotel.accentColor, size: 40.sp),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.star_rounded,
                              color: TravelloTheme.primaryMain, size: 13.sp),
                          SizedBox(width: 3.w),
                          Text(
...
class _AmenityBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Text(
          label,
          style: TextStyle(
              color: textColor, fontSize: 9.sp, fontWeight: FontWeight.w700),
        ),
      );
}
